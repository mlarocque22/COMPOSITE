def main():
    file = open(r"C:\Users\mark\Desktop\Penny Screens\NYSE\Sorted_Sector_$2.5.txt",'r')
    file1 = open(r"C:\Users\mark\Desktop\Penny Screens\NASDAQ\Sorted_Sector_$2.5.txt",'r') 
